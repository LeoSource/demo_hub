...
/* config */
#define CONFIG_XENO_BUILD_ARGS " 'CFLAGS=-march=armv7-a -mfpu=vfp3' 'LDFLAGS=-march=armv7-a' '--host=arm-linux-gnueabihf' '--with-core=cobalt' '--enable-smp' '--enable-dlopen-libs' '--enable-tls' 'host_alias=arm-linux-gnueabihf' 'CC=arm-linux-gnueabihf-gcc'"
...
/* Compiler */
#define CONFIG_XENO_COMPILER "gcc version 7.4.1 20181213 [linaro-7.4-2019.02 revision 56ec6f6b99cc167ff0c2f8e1a2eed33b1edc85d4] (Linaro GCC 7.4-2019.02) "
